...
class ReferDataset(data.Dataset):
    ...
    def __init__(self,
        ...
        # self.tokenizer = AutoTokenizer.from_pretrained(args.clip_dir)
        ...
        for r in ref_ids:
            ...
            for i, (el, sent_id) in enumerate(zip(ref['sentences'], ref['sent_ids'])):
                ...
                first_zero_index = input_ids.index(0) if 0 in input_ids else len(input_ids)
                input_ids = input_ids[:first_zero_index]
    ...
    def __getitem__(self, index):
        ...
        save_prefix = str(index) + "_" + self.sentence_raws[index][:-1]

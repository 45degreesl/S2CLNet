...
def get_parser():
    parser = argparse.ArgumentParser(description='S2CLNet Swin-BERT training and testing')
    ...
    parser.add_argument('--model_id', default='S2CLNet-SwinBERT', help='name to identify the model')
    parser.add_argument('--output-dir', default='./checkpoints/S2CLNet-SwinBERT/', help='path where to save checkpoint weights')

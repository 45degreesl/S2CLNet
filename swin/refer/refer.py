...
class REFER:
    ...
    def __init__(self, data_root, dataset='refcoco', splitBy='unc'):
        ...
        print(f"Looking for refs file at: {ref_file}")
        self.data = {}
        ...
        try:
            ...
            print(f"Successfully loaded refs file: {ref_file}")
        except FileNotFoundError:
            print(f"Refs file not found: {ref_file}")
            print("Please check the path and ensure the file exists.")
            sys.exit()
        except Exception as e:
            print(f"Error loading refs file {ref_file}: {e}")
            sys.exit()

        # load annotations from data/dataset/instances.json
        instances_file = osp.join(self.DATA_DIR, 'instances.json')
        print(f"Looking for instances file at: {instances_file}")
        try:
            instances = json.load(open(instances_file, 'r'))
            self.data['images'] = instances['images']
            self.data['annotations'] = instances['annotations']
            self.data['categories'] = instances['categories']
            print(f"Successfully loaded instances file: {instances_file}")
        except FileNotFoundError:
            print(f"Instances file not found: {instances_file}")
            print("Please check the path and ensure the file exists.")
            sys.exit()
        except Exception as e:
            print(f"Error loading instances file {instances_file}: {e}")
            sys.exit()
